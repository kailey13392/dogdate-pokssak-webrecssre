...
// API 호출을 위한 가짜 데이터 (더미 데이터는 이제 ��용하지 않음)
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setPopularDogs([
        ...
        { id: 4, name: '초��', breed: '요크셔테리어', age: 5, gender: '남아', city: '부산', district: '해운대구', bio: '간식이라면 뭐든지 하는 먹보랍니다.', imageUrl: 'https://images.unsplash.com/photo-1554196409-c44b5b7895f3?q=80&w=800', likes: 90 },
      ...
      setNearbyDogs([
        ...
        { id: 8, name: '콩이', breed: '퍼그', age: 3, gender: '여아', city: '서울', district: '광진구', bio: '주름진 얼굴��� 매력��인 콩이에요. 느긋한 산책을 즐겨요.', imageUrl: 'https://images.unsplash.com/photo-1534351450181-ea6f7d45e388?q=80&w=800', distance: '3km' },
    ...
    <div className="home-container">
      <section className="my-dog-section">
        ...
        <div className="my-dog-profile-wrapper">
          <button className="settings-button settings-button-on-card" aria-label="환경설��">
